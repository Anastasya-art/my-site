    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="article">
                ...
                <p>Это сайт предназначен для тех,кто хочет поделиться опытом в путешествиях по разным уголкам планеты.Вы можете посмотреть информацию о стране,поделиться своим впечаленими о ней,оценить качество транспорта,еды,дать рекомендации о жилье,об отношениях иостранцев к приезжим и т.д.</p>
            </div>
        </div>
        <div id="footer">
            <p>© IU4-12B</p>
